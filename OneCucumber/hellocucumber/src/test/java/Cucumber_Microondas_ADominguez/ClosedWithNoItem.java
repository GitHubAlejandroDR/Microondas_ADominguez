...
public class ClosedWithNoItem extends Estado_Microwave{
	...
	public void door_closed() {
		...
		// Cerrar la puerta con la puerta cerrada no involucra ninguna acci�n
	...
	public void item_placed() {
		...
		// Meter comida con la puerta cerrada no involucra ninguna acci�n
	...
	public void item_removed() {
		...
		// Sacar comida con la puerta cerrada no involucra ninguna acci�n
	...
	public void cooking_start() {
		...
		// Cooking con la puerta con la puerta cerrada sin comida no involucra ninguna acci�n
	...
	public void cooking_stop() {
		...
		// Stop Cooking  con la puerta con la puerta cerrada sin comida no involucra ninguna acci�n
	...
	public void tick() {
		...
		// Tick  con la puerta con la puerta cerrada sin comida no involucra ninguna acci�n
