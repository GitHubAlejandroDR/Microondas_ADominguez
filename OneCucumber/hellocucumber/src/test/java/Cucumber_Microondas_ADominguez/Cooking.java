...
public class Cooking extends Estado_Microwave {
	...
	public void door_opened() {
		...
		// Al abrir la puerta se debe de encender la l�mpara
	...
	public void time_dec() {
		...
		// Casos:
		// Timer = 0 -> No acci�n -> Display "Time: 0" -> Se pasa al estado
		// OpenWithNoItem
	...
	public void cooking_start() {
		...
		// Cooking en el estado cooking on no involucra ninguna acci�n
