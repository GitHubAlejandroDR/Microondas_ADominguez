...
public class OpenWithItem extends Estado_Microwave {
	...
	public void door_closed() {
		...
		// Al cerrar la puerta se debe de apagar la l�mpara
	...
	public void item_placed() {
		...
		// Meter comida con comida dentro no involucra ninguna acci�n
	...
	public void cooking_start() {
		...
		// Cooking con la puerta con la puerta abierta no involucra ninguna acci�n
	...
	public void cooking_stop() {
		...
		// Stop Cooking con la puerta con la puerta abierta no involucra ninguna acci�n
	...
	public void tick() {
		...
		// Tick con la puerta con la puerta abierta no involucra ninguna acci�n
